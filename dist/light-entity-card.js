...
`,Ht=(t,e)=>t.reduce((t,i)=>(i.defineId?t[i.defineId]=i:i.promise.then(t=>{void 0===e.registry.get(i.name)&&e.registry.define(i.name,t)}),t),{}),It=t=>({name:t,promise:customElements.whenDefined(t).then(()=>customElements.get(t))}),Nt=(t,e,i={},n={})=>{const r=new Event(e,{bubbles:void 0===n.bubbles||n.bubbles,cancelable:Boolean(n.cancelable),composed:void 0===n.composed||n.composed});return r.detail=i,t.dispatchEvent(r),r};class Vt extends(Tt(Et)){static get elementDefinitions(){return Ht([It("ha-checkbox"),It("ha-formfield"),It("ha-form-string"),It("ha-select"),It("mwc-list-item")],Vt)}static get styles(){return Rt}static get properties(){return{hass:{},_config:{}}}setConfig(t){this._config={...Ut,...t}}get entityOptions(){const t=Object.keys(this.hass.states).filter(t=>["switch","light","group"].includes(t.substr(0,t.indexOf("."))));return t.sort(),t}firstUpdated(){this._firstRendered=!0}render(){if(!this.hass||!this._config)return X``;let{header:t}=this._config;if(!t&&this._config.entity){let e=this._config.entity.split(".")[1]||"";e&&(e=e.charAt(0).toUpperCase()+e.slice(1),t=e)}const e=this.entityOptions.map(t=>X`<mwc-list-item value="${t}" ?selected=${t===this._config.entity}>${t}</mwc-list-item>`);return X`
    ...
    `}showPercent(t,e,i){if(!this.config.show_slider_percent)return X``;let n=parseInt(100*(t-e)/(i-e),10);return isNaN(n)&&(n=0),X` <div class="percent-slider">${n}%</div> `}createColorTemperature(t){if(!1===this.config.color_temp)return X``;if(this.dontShowFeature("colorTemp",t))return X``;const e=void 0!==t.attributes.min_color_temp_kelvin;let i,n,r;if(e){const e=t.attributes.color_temp_kelvin,o=t.attributes.min_color_temp_kelvin,s=t.attributes.max_color_temp_kelvin;if(!o||!s)return X``;i=e?Math.round(1e6/e):null,n=Math.round(1e6/s),r=Math.round(1e6/o)}else i=t.attributes.color_temp,n=t.attributes.min_mireds,r=t.attributes.max_mireds;const o=this.showPercent(i,n,r);return X`
      <div class="control light-entity-card-center">
        <div class="icon-container">
