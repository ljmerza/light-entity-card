...
/* eslint no-console: 0 */
console.info(`%c  LIGHT-ENTITY-CARD   \n%c  Version ${_package_json__WEBPACK_IMPORTED_MODULE_5__.version}       `, "color: orange; font-weight: bold; background: black", "color: white; font-weight: bold; background: dimgray");
...
class LightEntityCard extends lit_element__WEBPACK_IMPORTED_MODULE_1__["LitElement"] {
  ...
  render() {
    ...
    const templates = this._shownStateObjects.reduce((htmlTemplate, stateObj) => {
      return lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]`${htmlTemplate}${this.createEntityTemplate(stateObj)}`;
    }, ``);
