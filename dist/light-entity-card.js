...
/***/ "./node_modules/@lit-labs/scoped-registry-mixin/node_modules/@lit/reactive-element/css-tag.js":
/*!****************************************************************************************************!*\
  !*** ./node_modules/@lit-labs/scoped-registry-mixin/node_modules/@lit/reactive-element/css-tag.js ***!
  \****************************************************************************************************/
...
/* harmony import */ var _lit_reactive_element_css_tag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @lit/reactive-element/css-tag.js */ "./node_modules/@lit-labs/scoped-registry-mixin/node_modules/@lit/reactive-element/css-tag.js");

/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function e(e){return class extends e{createRenderRoot(){const e=this.constructor,{registry:s,elementDefinitions:n,shadowRootOptions:o}=e;n&&!s&&(e.registry=new CustomElementRegistry,Object.entries(n).forEach((([t,s])=>e.registry.define(t,s))));const i=this.renderOptions.creationScope=this.attachShadow({...o,customElements:e.registry});return Object(_lit_reactive_element_css_tag_js__WEBPACK_IMPORTED_MODULE_0__["adoptStyles"])(i,this.constructor.elementStyles),i}}}
...
var i = window,
  ...
  for (var _i = 0; _i < s; _i++) {
    ...
    for (; _g < _s.length && (d.lastIndex = _g, _u = d.exec(_s), null !== _u);) {
      _g = d.lastIndex, d === v ? "!--" === _u[1] ? d = a : void 0 !== _u[1] ? d = f : void 0 !== _u[2] ? ($.test(_u[2]) && (h = RegExp("</" + _u[2], "g")), d = _) : void 0 !== _u[3] && (d = _) : d === _ ? ">" === _u[0] ? (d = null != h ? h : v, _c = -1) : void 0 === _u[1] ? _c = -2 : (_c = d.lastIndex - _u[2].length, _e = _u[1], d = void 0 === _u[3] ? _ : '"' === _u[3] ? p : m) : d === p || d === m ? d = _ : d === a || d === f ? d = v : (d = _, h = void 0);
    }
  ...
  function C(_ref, e) {
    ...
    for (; null !== (l = A.nextNode()) && c.length < u;) {
      if (1 === l.nodeType) {
        ...
        if ($.test(l.tagName)) {
          ...
          if (_i7 > 0) {
            ...
            for (var _s3 = 0; _s3 < _i7; _s3++) {
              l.append(_t5[_s3], r()), A.nextNode(), c.push({
                type: 2,
                index: ++h
              });
            }
        ...
        for (; -1 !== (_t6 = l.data.indexOf(o, _t6 + 1));) {
          c.push({
            type: 7,
            index: h
          }), _t6 += o.length - 1;
    ...
    value: function _$AI(t) {
      ...
      if (void 0 === o) t = P(this, t, i, 0), n = !d(t) || t !== this._$AH && t !== x, n && (this._$AH = t);else {
        ...
        for (t = o[0], _l = 0; _l < o.length - 1; _l++) {
          _h = P(this, _e2[s + _l], i, _l), _h === x && (_h = this._$AH[_l]), n || (n = !d(_h) || _h !== this._$AH[_l]), _h === b ? t = b : t !== b && (t += (null != _h ? _h : "") + o[_l + 1]), this._$AH[_l] = _h;
        }
      }
      n && !e && this.j(t);
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lit_reactive_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @lit/reactive-element */ "./node_modules/lit/node_modules/@lit/reactive-element/reactive-element.js");
...
/* harmony import */ var _css_tag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./css-tag.js */ "./node_modules/lit/node_modules/@lit/reactive-element/css-tag.js");
...
/* harmony default export */ __webpack_exports__["default"] = (globalElementLoader);
...
/* harmony import */ var _lit_labs_scoped_registry_mixin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @lit-labs/scoped-registry-mixin */ "./node_modules/@lit-labs/scoped-registry-mixin/scoped-registry-mixin.js");
...
class LightEntityCardEditor extends Object(_lit_labs_scoped_registry_mixin__WEBPACK_IMPORTED_MODULE_1__["ScopedRegistryHost"])(lit__WEBPACK_IMPORTED_MODULE_0__["LitElement"]) {
  static get elementDefinitions() {
    return Object(_buildElementDefinitions__WEBPACK_IMPORTED_MODULE_4__["default"])([
      Object(_globalElementLoader__WEBPACK_IMPORTED_MODULE_5__["default"])('ha-checkbox'),
      Object(_globalElementLoader__WEBPACK_IMPORTED_MODULE_5__["default"])('ha-formfield'),
      Object(_globalElementLoader__WEBPACK_IMPORTED_MODULE_5__["default"])('ha-form-string'),
      Object(_globalElementLoader__WEBPACK_IMPORTED_MODULE_5__["default"])('ha-select'),
      Object(_globalElementLoader__WEBPACK_IMPORTED_MODULE_5__["default"])('mwc-list-item'),
  ...
  render() {
    ...
    const options = this.entityOptions.map(entity => lit__WEBPACK_IMPORTED_MODULE_0__["html"]`<mwc-list-item value="${entity}" ?selected=${entity === this._config.entity}>${entity}</mwc-list-item>`);
...
/* harmony import */ var _buildElementDefinitions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./buildElementDefinitions */ "./src/buildElementDefinitions.js");
/* harmony import */ var _globalElementLoader__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./globalElementLoader */ "./src/globalElementLoader.js");
...
customElements.define(editorName, _index_editor__WEBPACK_IMPORTED_MODULE_5__["default"]);

console.info(`light-entity-card v${_package_json__WEBPACK_IMPORTED_MODULE_6__.version}`);

class LightEntityCard extends Object(_lit_labs_scoped_registry_mixin__WEBPACK_IMPORTED_MODULE_1__["ScopedRegistryHost"])(lit__WEBPACK_IMPORTED_MODULE_0__["LitElement"]) {
  static get elementDefinitions() {
    return Object(_buildElementDefinitions__WEBPACK_IMPORTED_MODULE_7__["default"])(
      [
        Object(_globalElementLoader__WEBPACK_IMPORTED_MODULE_8__["default"])('ha-card'),
        Object(_globalElementLoader__WEBPACK_IMPORTED_MODULE_8__["default"])('more-info-light'),
        Object(_globalElementLoader__WEBPACK_IMPORTED_MODULE_8__["default"])('ha-switch'),
        Object(_globalElementLoader__WEBPACK_IMPORTED_MODULE_8__["default"])('ha-icon'),
        Object(_globalElementLoader__WEBPACK_IMPORTED_MODULE_8__["default"])('ha-slider'),
        Object(_globalElementLoader__WEBPACK_IMPORTED_MODULE_8__["default"])('ha-color-picker'),
        Object(_globalElementLoader__WEBPACK_IMPORTED_MODULE_8__["default"])('ha-select'),
        Object(_globalElementLoader__WEBPACK_IMPORTED_MODULE_8__["default"])('mwc-list-item'),
      ],
      LightEntityCard
    );
  }
  ...
  setColorWheels() {
    ...
    for(let entity of entities) {
      ...
      const colorPicker = new _jaames_iro__WEBPACK_IMPORTED_MODULE_2__["default"].ColorPicker(picker, {
        width: 320,
        color,
        sliderSize: 0
      });
  ...
  setConfig(config) {
    ...
    this.config = {
      ..._defaults__WEBPACK_IMPORTED_MODULE_4__["default"],
      ...config,
    };
  }
   ...
   */
  get styles() {
    return _style__WEBPACK_IMPORTED_MODULE_3__["default"];
  }
  ...
  render() {
    ...
    const templates = this._shownStateObjects.reduce(
      (htmlTemplate, stateObj) => lit__WEBPACK_IMPORTED_MODULE_0__["html"]`${htmlTemplate}${this.createEntityTemplate(stateObj)}`,
  ...
  createHeader(stateObj) {
    if (this.config.hide_header) return lit__WEBPACK_IMPORTED_MODULE_0__["html"]``;
  ...
  createBrightnessSlider(stateObj) {
    if (this.config.brightness === false) return lit__WEBPACK_IMPORTED_MODULE_0__["html"]``;
    if (this.dontShowFeature('brightness', stateObj)) return lit__WEBPACK_IMPORTED_MODULE_0__["html"]``;
  ...
  createSpeedSlider(stateObj) {
    if (this.config.speed === false) return lit__WEBPACK_IMPORTED_MODULE_0__["html"]``;
    if (this.dontShowFeature('speed', stateObj)) return lit__WEBPACK_IMPORTED_MODULE_0__["html"]``;
  ...
  createIntensitySlider(stateObj) {
    if (this.config.speed === false) return lit__WEBPACK_IMPORTED_MODULE_0__["html"]``;
    if (this.dontShowFeature('intensity', stateObj)) return lit__WEBPACK_IMPORTED_MODULE_0__["html"]``;
  ...
  showPercent(value, min, max) {
    if (!this.config.show_slider_percent) return lit__WEBPACK_IMPORTED_MODULE_0__["html"]``;
    let percent = parseInt(((value - min) * 100) / (max - min), 0);
    if (isNaN(percent)) percent = 0;

    return lit__WEBPACK_IMPORTED_MODULE_0__["html"]` <div class="percent-slider">${percent}%</div> `;
  }
  ...
  createColorTemperature(stateObj) {
    if (this.config.color_temp === false) return lit__WEBPACK_IMPORTED_MODULE_0__["html"]``;
    if (this.dontShowFeature('colorTemp', stateObj)) return lit__WEBPACK_IMPORTED_MODULE_0__["html"]``;
  ...
  createWhiteValue(stateObj) {
    if (this.config.white_value === false) return lit__WEBPACK_IMPORTED_MODULE_0__["html"]``;
    if (this.dontShowFeature('whiteValue', stateObj)) return lit__WEBPACK_IMPORTED_MODULE_0__["html"]``;
  ...
  createEffectList(stateObj) {
    ...
    if (this.config.effects_list === false) return lit__WEBPACK_IMPORTED_MODULE_0__["html"]``;
    ...
    if (!this.config.persist_features && !this.isEntityOn(stateObj)) return lit__WEBPACK_IMPORTED_MODULE_0__["html"]``;
  ...
  createListItem(stateObj, effect) {
    return lit__WEBPACK_IMPORTED_MODULE_0__["html"]`<mwc-list-item value="${effect}" ?selected=${effect === stateObj.attributes.effect}
  ...
  createColorPicker(stateObj) {
    if (this.config.color_picker === false) return lit__WEBPACK_IMPORTED_MODULE_0__["html"]``;
    if (this.dontShowFeature('color', stateObj)) return lit__WEBPACK_IMPORTED_MODULE_0__["html"]``;
...
const style = lit__WEBPACK_IMPORTED_MODULE_0__["css"]`
  .entities {
    padding-top: 10px;
    padding-bottom: 10px;
    display: flex;
