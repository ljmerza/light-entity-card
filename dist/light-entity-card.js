...
`,ni={shorten_cards:!1,consolidate_entities:!1,child_card:!1,hide_header:!1,show_header_icon:!1,header:"",color_wheel:!0,persist_features:!1,brightness:!0,color_temp:!0,white_value:!0,warm_white_value:!0,color_picker:!0,speed:!0,intensity:!0,force_features:!1,show_slider_percent:!1,full_width_sliders:!1,brightness_icon:"weather-sunny",white_icon:"file-word-box",warm_white_icon:"weather-sunset",temperature_icon:"thermometer",speed_icon:"speedometer",intensity_icon:"transit-connection-horizontal"};var ri=l`
  .entities {
    padding-top: 10px;
    padding-bottom: 10px;
    display: flex;
...
`;var oi=(t,e)=>t.reduce((t,i)=>(i.defineId?t[i.defineId]=i:i.promise.then(t=>{void 0===e.registry.get(i.name)&&e.registry.define(i.name,t)}),t),{});var si=t=>({name:t,promise:customElements.whenDefined(t).then(()=>customElements.get(t))});const ai=(t,e,i={},n={})=>{const r=new Event(e,{bubbles:void 0===n.bubbles||n.bubbles,cancelable:Boolean(n.cancelable),composed:void 0===n.composed||n.composed});return r.detail=i,t.dispatchEvent(r),r};class li extends(ei(Ct)){static get elementDefinitions(){return oi([si("ha-checkbox"),si("ha-formfield"),si("ha-form-string"),si("ha-select"),si("mwc-list-item")],li)}static get styles(){return ri}static get properties(){return{hass:{},_config:{}}}setConfig(t){this._config={...ni,...t}}get entityOptions(){const t=Object.keys(this.hass.states).filter(t=>["switch","light","group"].includes(t.substr(0,t.indexOf("."))));return t.sort(),t}firstUpdated(){this._firstRendered=!0}render(){if(!this.hass)return Q``;let{header:t}=this._config;if(!t&&this._config.entity){let e=this._config.entity.split(".")[1]||"";e&&(e=e.charAt(0).toUpperCase()+e.slice(1),t=e)}const e=this.entityOptions.map(t=>Q`<mwc-list-item value="${t}" ?selected=${t===this._config.entity}>${t}</mwc-list-item>`);return Q`
    ...
    `}createIntensitySlider(t){return!1===this.config.intensity||this.dontShowFeature("intensity",t)?Q``:Q`
      <div class="control light-entity-card-center">
        <div class="icon-container">
    ...
    `}showPercent(t,e,i){if(!this.config.show_slider_percent)return Q``;let n=parseInt(100*(t-e)/(i-e),10);return isNaN(n)&&(n=0),Q` <div class="percent-slider">${n}%</div> `}createColorTemperature(t){if(!1===this.config.color_temp)return Q``;if(this.dontShowFeature("colorTemp",t))return Q``;const e=void 0!==t.attributes.min_color_temp_kelvin,i=e?t.attributes.color_temp_kelvin:t.attributes.color_temp,n=e?t.attributes.min_color_temp_kelvin:t.attributes.min_mireds,r=e?t.attributes.max_color_temp_kelvin:t.attributes.max_mireds,o=e?"color_temp_kelvin":"color_temp",s=this.showPercent(i,n,r);return Q`
      <div class="control light-entity-card-center">
        <div class="icon-container">
    ...
    `}getWhiteValue(t,e=3){const i=t.attributes.rgbw_color,n=t.attributes.rgbww_color;return i&&3===e?i[3]||0:n&&e<n.length?n[e]||0:3===e&&void 0!==t.attributes.white_value?t.attributes.white_value:0}createWhiteValue(t){if(!1===this.config.white_value)return Q``;if(this.dontShowFeature("whiteValue",t))return Q``;const e=this.getWhiteValue(t,3);return Q`
      <div class="control light-entity-card-center">
        <div class="icon-container">
    ...
    `}createWarmWhiteValue(t){if(!1===this.config.warm_white_value)return Q``;if(this.dontShowFeature("warmWhiteValue",t))return Q``;const e=this.getWhiteValue(t,4);return Q`
      <div class="control light-entity-card-center">
        <div class="icon-container">
