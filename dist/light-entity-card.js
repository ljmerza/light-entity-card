...
function () {
  ...
  _createClass(NodePart, [{
    ...
    value: function appendIntoPart(part) {
      part.__insert(this.startNode = Object(_template_js__WEBPACK_IMPORTED_MODULE_13__["createMarker"])());

      part.__insert(this.endNode = Object(_template_js__WEBPACK_IMPORTED_MODULE_13__["createMarker"])());
    }
    /**
    ...
    value: function insertAfterPart(ref) {
      ref.__insert(this.startNode = Object(_template_js__WEBPACK_IMPORTED_MODULE_13__["createMarker"])());
    ...
    key: "commit",
    value: function commit() {
      while (Object(_directive_js__WEBPACK_IMPORTED_MODULE_8__["isDirective"])(this.__pendingValue)) {
        var directive = this.__pendingValue;
        this.__pendingValue = _part_js__WEBPACK_IMPORTED_MODULE_10__["noChange"];
        directive(this);
      }
...
function () {
  ...
  _createClass(BooleanAttributePart, [{
    ...
    value: function commit() {
      ...
      if (this.__pendingValue === _part_js__WEBPACK_IMPORTED_MODULE_10__["noChange"]) {
        return;
      }
...
/* harmony import */ var core_js_modules_es6_weak_map__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! core-js/modules/es6.weak-map */ "./node_modules/core-js/modules/es6.weak-map.js");
/* harmony import */ var core_js_modules_es6_weak_map__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_weak_map__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _dom_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./dom.js */ "./node_modules/lit-html/lib/dom.js");
/* harmony import */ var _modify_template_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modify-template.js */ "./node_modules/lit-html/lib/modify-template.js");
/* harmony import */ var _render_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./render.js */ "./node_modules/lit-html/lib/render.js");
/* harmony import */ var _template_factory_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./template-factory.js */ "./node_modules/lit-html/lib/template-factory.js");
/* harmony import */ var _template_instance_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./template-instance.js */ "./node_modules/lit-html/lib/template-instance.js");
/* harmony import */ var _template_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./template.js */ "./node_modules/lit-html/lib/template.js");
/* harmony import */ var _lit_html_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../lit-html.js */ "./node_modules/lit-html/lit-html.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "html", function() { return _lit_html_js__WEBPACK_IMPORTED_MODULE_17__["html"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "svg", function() { return _lit_html_js__WEBPACK_IMPORTED_MODULE_17__["svg"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TemplateResult", function() { return _lit_html_js__WEBPACK_IMPORTED_MODULE_17__["TemplateResult"]; });
...
var shadyTemplateFactory = function shadyTemplateFactory(scopeName) {
  return function (result) {
    ...
    var templateCache = _template_factory_js__WEBPACK_IMPORTED_MODULE_14__["templateCaches"].get(cacheKey);
    ...
    if (templateCache === undefined) {
      ...
      _template_factory_js__WEBPACK_IMPORTED_MODULE_14__["templateCaches"].set(cacheKey, templateCache);
    }
    ...
    var key = result.strings.join(_template_js__WEBPACK_IMPORTED_MODULE_16__["marker"]);
    ...
    if (template === undefined) {
      ...
      template = new _template_js__WEBPACK_IMPORTED_MODULE_16__["Template"](result, element);
...
var removeStylesFromLitTemplates = function removeStylesFromLitTemplates(scopeName) {
  TEMPLATE_TYPES.forEach(function (type) {
    var templates = _template_factory_js__WEBPACK_IMPORTED_MODULE_14__["templateCaches"].get(getTemplateCacheKey(type, scopeName));
    ...
    if (templates !== undefined) {
      templates.keyString.forEach(function (template) {
        ...
        Object(_modify_template_js__WEBPACK_IMPORTED_MODULE_12__["removeNodesFromTemplate"])(template, styles);
      });
    }
  });
};
...
var prepareTemplateStyles = function prepareTemplateStyles(scopeName, renderedDOM, template) {
  ...
  if (!!template) {
    Object(_modify_template_js__WEBPACK_IMPORTED_MODULE_12__["insertNodeIntoTemplate"])(template, condensedStyle, content.firstChild);
  } else {
  ...
  if (window.ShadyCSS.nativeShadow && style !== null) {
    ...
    Object(_modify_template_js__WEBPACK_IMPORTED_MODULE_12__["removeNodesFromTemplate"])(template, removes);
  }
};
/**
...
var render = function render(result, container, options) {
  ...
  var hasRendered = _render_js__WEBPACK_IMPORTED_MODULE_13__["parts"].has(container);
  ...
  Object(_render_js__WEBPACK_IMPORTED_MODULE_13__["render"])(result, renderContainer, Object.assign({
  ...
  if (firstScopeRender) {
    var part = _render_js__WEBPACK_IMPORTED_MODULE_13__["parts"].get(renderContainer);
    _render_js__WEBPACK_IMPORTED_MODULE_13__["parts"].delete(renderContainer); // ShadyCSS might have style sheets (e.g. from `prepareAdoptedCssText`)
    // that should apply to `renderContainer` even if the rendered value is
    // not a TemplateInstance. However, it will only insert scoped styles
    // into the document if `prepareTemplateStyles` has already been called
    // for the given scope name.

    var template = part.value instanceof _template_instance_js__WEBPACK_IMPORTED_MODULE_15__["TemplateInstance"] ? part.value.template : undefined;
    prepareTemplateStyles(scopeName, renderContainer, template);
    Object(_dom_js__WEBPACK_IMPORTED_MODULE_11__["removeNodes"])(container, container.firstChild);
    container.appendChild(renderContainer);
    _render_js__WEBPACK_IMPORTED_MODULE_13__["parts"].set(container, part);
  ...
  _createClass(TemplateResult, [{
    ...
    value: function getHTML() {
      ...
      for (var i = 0; i < l; i++) {
        ...
        var attributeMatch = _template_js__WEBPACK_IMPORTED_MODULE_8__["lastAttributeNameRegex"].exec(s);
        ...
        if (attributeMatch === null) {
          ...
          // below.
          html += s + (isCommentBinding ? _template_js__WEBPACK_IMPORTED_MODULE_8__["marker"] : _template_js__WEBPACK_IMPORTED_MODULE_8__["nodeMarker"]);
        } else {
          // For attributes we use just a marker sentinel, and also append a
          // $lit$ suffix to the name to opt-out of attribute-specific parsing
          // that IE and Edge do for style and certain SVG attributes.
          html += s.substr(0, attributeMatch.index) + attributeMatch[1] + attributeMatch[2] + _template_js__WEBPACK_IMPORTED_MODULE_8__["boundAttributeSuffix"] + attributeMatch[3] + _template_js__WEBPACK_IMPORTED_MODULE_8__["marker"];
        }
      }
...
module.exports = JSON.parse("{\"name\":\"light-entity-card\",\"version\":\"4.2.2\",\"description\":\"A light-entity card for Home Assistant Lovelace UI\",\"keywords\":[\"home-assistant\",\"homeassistant\",\"hass\",\"automation\",\"lovelace\",\"custom-cards\",\"light-entity\"],\"repository\":\"git@github.com:ljmerza/light-entity-card.git\",\"author\":\"Leonardo Merza <ljmerza@gmail.com>\",\"license\":\"MIT\",\"dependencies\":{\"@babel/polyfill\":\"^7.4.3\",\"core-js\":\"^2.6.5\",\"lit\":\"^2.0.0-rc.2\",\"lit-element\":\"^2.1.0\"},\"devDependencies\":{\"@babel/cli\":\"^7.4.3\",\"@babel/core\":\"^7.4.3\",\"@babel/preset-env\":\"^7.4.3\",\"@babel/register\":\"^7.4.0\",\"babel-loader\":\"^8.0.5\",\"eslint\":\"^5.16.0\",\"eslint-config-airbnb-base\":\"^13.1.0\",\"eslint-plugin-import\":\"^2.17.1\",\"webpack\":\"^4.30.0\",\"webpack-cli\":\"^3.3.0\",\"webpack-merge\":\"^4.2.1\"},\"scripts\":{\"lint\":\"eslint ./src\",\"start\":\"webpack --watch --config webpack/config.dev.js\",\"build\":\"webpack --config webpack/config.prod.js\"}}");
...
class LightEntityCardEditor extends lit_element__WEBPACK_IMPORTED_MODULE_0__["LitElement"] {
  static get styles() {
  ...
  setConfig(config) {
    this._config = {
      ..._defaults__WEBPACK_IMPORTED_MODULE_2__["default"],
      ...config,
    };
  }
  ...
  render() {
    ...
    const options = this.entityOptions.map(entity => {
      return lit_element__WEBPACK_IMPORTED_MODULE_0__["html"]`<paper-item>${entity}</paper-item>`;
    });
...
/* eslint no-console: 0 */
console.info(
  `%c  LIGHT-ENTITY-CARD   \n%c  Version ${_package_json__WEBPACK_IMPORTED_MODULE_5__.version}       `,
  'color: orange; font-weight: bold; background: black',
  // eslint-disable-next-line comma-dangle
  'color: white; font-weight: bold; background: dimgray'
);

class LightEntityCard extends lit_element__WEBPACK_IMPORTED_MODULE_1__["LitElement"] {
  async firstUpdated() {
  ...
  render() {
    ...
    const templates = this._shownStateObjects.reduce(
      (htmlTemplate, stateObj) => lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]`${htmlTemplate}${this.createEntityTemplate(stateObj)}`,
      // eslint-disable-next-line comma-dangle
      ''
    );
  ...
  createHeader(stateObj) {
    if (this.config.hide_header) return lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]``;
  ...
  createBrightnessSlider(stateObj) {
    if (this.config.brightness === false) return lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]``;
    if (this.dontShowFeature('brightness', stateObj)) return lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]``;
  ...
  showPercent(value, min, max) {
    if (!this.config.show_slider_percent) return lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]``;
    let percent = parseInt(((value - min) * 100) / (max - min), 0);
    if (isNaN(percent)) percent = 0;

    return lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]` <div class="percent-slider">${percent}%</div> `;
  }
  ...
  createColorTemperature(stateObj) {
    if (this.config.color_temp === false) return lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]``;
    if (this.dontShowFeature('colorTemp', stateObj)) return lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]``;
  ...
  createWhiteValue(stateObj) {
    if (this.config.white_value === false) return lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]``;
    if (this.dontShowFeature('whiteValue', stateObj)) return lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]``;
  ...
  createEffectList(stateObj) {
    ...
    if (this.config.effects_list === false) return lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]``;
    ...
    if (!this.config.persist_features && !this.isEntityOn(stateObj)) return lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]``;
    ...
    const listItems = effect_list.map(effect => lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]`<paper-item>${effect}</paper-item>`);
  ...
  createColorPicker(stateObj) {
    if (this.config.color_picker === false) return lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]``;
    if (this.dontShowFeature('color', stateObj)) return lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]``;
