...
class LightEntityCard extends lit_element__WEBPACK_IMPORTED_MODULE_1__["LitElement"] {
  ...
  createEffectList(stateObj) {
    ...
    const listItems = effect_list.map(
      (effect) => lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]`<paper-item>${effect}</paper-item>`
    );
