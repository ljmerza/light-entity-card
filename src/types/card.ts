 ...
 */
export function isValidConfig(config: any): config is LightEntityCardConfig {
  return (
    config &&
 ...
 */
export function isSwitchEntity(entityId: string): boolean {
 ...
 */
export function isGroupEntity(entityId: string): boolean {
